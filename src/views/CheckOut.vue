            ...
            <div class="col-12 my-3">
                ...
                <div class="collapse" id="checkout">
                    <div class="card card-body border-light">
                        <table class="table table-bordered text-center" v-for="(item, index) in cart" :key="index">
                            ...
                            <tbody>
                                <tr> 
                                    ...
                                    <td>{{ item.quantity }}</td>
                                    <td class="text-end">${{ getTotalPrice(item) }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
export default {
    ...
    methods:{
        ...
        getTotalPrice(item){
            const price = parseInt(item.product_price)
        ...
        TotalAmount(){
            ...
            this.cart.forEach(item => {
                let singleprice =  item.quantity * item.product_price
                total += singleprice
            });
